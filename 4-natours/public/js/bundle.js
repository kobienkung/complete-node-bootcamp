...
var bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          stripe = Stripe('pk_test_51NmAGuL6zyjmHBvBKipfQajxwVXVrlbXHDKbIwRQQBGF8thg8bjhOf63ywyQzRk5mXNLLzQ8UOlskJmT53wgq2lI00BPbYVPTy'); // Stripe got from script(src='https://js.stripe.com/v3/') (base.pug) and use public key
          _context.prev = 1;
          _context.next = 4;
...
var userPhotoForm = document.querySelector('.form__upload');
...
if (userPhotoForm) userPhotoForm.addEventListener('change', /*#__PURE__*/function () {
...
if (bookBtn) {
  bookBtn.addEventListener('click', function (e) {
    ...
    var tourId = e.target.dataset.tourId; // from (data-tour-id=`${tour.id}`)
    console.log(tourId);
